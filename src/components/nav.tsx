...
export default function Nav() {
	...
	return (
		<nav className="flex justify-between items-center font-medium pt-12 pb-6 mb-24">
			<div>
				<a href="/">
					<svg
						id="logo-70"
			...
			{isOpen && !matches && (
				<motion.div
					...
					className="bg-white fixed bottom-0 left-0 w-full h-screen flex items-center justify-center"
				>
					<motion.div
						variants={navMotion}
						animate="visible"
